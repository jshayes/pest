...
describe('matching describe block names', function () {
    ...
    describe('outer', function () {
        ...
        describe('middle', function () {
            test('should not call beforeEach functions for sibling describe blocks with the same name', function () {
                expect($this->foo)->toBe(2);
            });
        });

        describe('inner', function () {
            test('should not call beforeEach functions for descendent of sibling describe blocks with the same name', function () {
                expect($this->foo)->toBe(2);
            });
        });
    });
